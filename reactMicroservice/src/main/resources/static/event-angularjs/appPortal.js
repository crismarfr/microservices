...
//           		self.onDispose();
//           	    window.close();
            } else if(msg.msg === "Open event")
            	   {
            			console.log(""+msg.msg); 
            			          	
                    	window.localStorage[""+self.idConseiller+self.idClient] = JSON.stringify([{ 
                  	      idConseiller: ""+ self.idConseiller,
                  	      idClient: ""+ self.idClient,
                  	      lastEventId: ""+ self.lastEventId
                  	    }]); 
            			
            			indiceWebApp++;
            			var webAppName="WebApp"+indiceWebApp++;
            			
            			window.open('/event-angularjs/webapp.html',webAppName,'menubar=no, scrollbars=no')
            	   }
        }
    };
    ...
    self.onClickSendEventOpen = function () {
        console.log("open");
